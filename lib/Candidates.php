    ...
    public function get($candidateID)
    {
        $sql = sprintf(
            "SELECT
                ...
                ((year(now())-year(candidate.date_work))) AS workage,
...
class CandidatesDataGrid extends DataGrid
{
    ...
    public function __construct($instanceName, $siteID, $parameters, $misc = 0)
    {
        ...
        $this->_classColumns = array(
            ...
            '工作年限' =>      array('select'   => '((year(now())-year(candidate.date_work))) AS workAge',
            ...
            '年龄' =>      array('select'   => '((year(now())-year(candidate.date_birth))) AS age',
